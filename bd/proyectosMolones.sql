...
--
-- Host: localhost    Database: proyectos-molones
-- ------------------------------------------------------
...
CREATE TABLE `author` (
  ...
  `job` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `projects` (
  ...
  `name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
  `description` text COLLATE utf8mb4_general_ci,
  `thecnologies` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dump completed on 2025-12-11 12:19:15
